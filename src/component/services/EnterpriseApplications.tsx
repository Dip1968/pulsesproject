  ...
  return (
    <div className="Enterprise-Applications">
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.reliancepulses.com/enterprise-applications"
        />
        ...
        <meta
          property="og:url"
          content="https://www.reliancepulses.com/enterprise-applications"
        />
        <meta
          name="twitter:title"
          ...
          <Row>
            ...
            <Col xs={12} md={6}>
              <div className="banner-img">
                <img
                  src={enterpriseapplicationsbanner}
          ...
          <div className=" syno-adv mildblue-bg p-5">
            ...
            <Row>
              <Col xs={12} md={6}>
                <ul className="icon-list">
                  <li>
                    Experience of handling Implementations, Upgrades, Rollouts &
                    Maintenance across geographies & domains
                  </li>
                  <li>
                    Proven Project Management methodologies to ensure on time,
                    on budget execution
                  </li>
                </ul>
              </Col>
              <Col xs={12} md={6}>
                <ul className="icon-list">
                  <li>
                    Expertise to make recommendations and provide right solution
