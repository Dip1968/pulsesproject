...
function ourstory() {
  ...
  return (
    <div className="our-story">
      <Helmet>
        <title>IT solutions and services | Our Story | Synoverge</title>
      ...
      <link rel="canonical" href="https://www.reliancepulses.com/our-story" />
          ...
          <Row>
            <Col xs={12} md={6}>
              <div className="banner-cont">
                ...
                <p>
                  Helping customers achieve goals and create value with their
      ...
      <div className="module">
        <Container>
          ...
          <Row>
            ...
            <Col md={12}>
              <p>
                Synoverge is a global Digital Transformation & Platform
                Engineering services company working as strategic partner with
                organizations globally, across industry verticals. We facilitate
                business transformation through technology adoption. Our
                innovative S3+ service delivery framework provides tomorrow’s
                solutions to our clients with faster turn around and higher
                predictability. At Synoverge, we believe in co-creating and
                energizing ideas through mutual synergies.
              </p>
              <p>
                Synoverge was founded in 2010 and now has hundreds of bright
                engineering minds working together with one mission – Help our
                customers succeed! Synoverge operates out of state-of-the-art
                infrastructure in the city of Ahmedabad. Synoverge has a modern
                office environment and IT infrastructure that is ISMS compliant.
                Synoverge’s mature work environment facilitates innovation on
                our client engagements through:
              </p>
              <ul className="icon-list">
                <li>An environment that embraces new ideas & facilitate R&D</li>
                <li>
                  Providing equal opportunities to all to express and experiment
                </li>
              ...
              <p>
                Synoverge is an ISO 9001:2015 certified company, indicating the
                maturity of our delivery processes, adherence to internationally
                recognized standards, and continued dedication to Quality and
                Organizational Excellence.
              </p>
              <p>
                We have established enormous confidence among our increasing
                circles of clients because of our persistent conviction in
                inclusive growth, our high-quality services, and our solid
                support system. This never-ending quest for trustworthiness has
                allowed us to service customers across United States, UK,
                Canada, Germany, Netherlands, India, Japan, and Australia.
              </p>
            </Col>
          </Row>
        </Container>
          ...
          <Row>
            ...
            >
              <div className="content-spacing-right">
                ...
                <p>
                  We are on mission to build an organization that delivers
                  integrated IT solutions aligned with clients’ business needs
                  with focus on:
                </p>
          ...
          <Row>
            ...
            <Col xs={12} lg={6} className="common-sec">
              <div className="content-spacing-left">
                ...
                <p className="mb-0">
                  Synoverge Vision is to be a progressive organization offering
                  competitive edge to enterprises globally and be their first
                  choice as a technology partner in the ever changing business
                  environment; thus creating a value for stakeholders
                </p>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            ...
            >
              <div className="content-spacing-right">
                ...
                <p>
                  Synoverge has been founded by a team of professionals having a
                  strong pedigree; with each one of them bringing a rich &
                  credible experience of working with Tier -1 IT consulting
                  companies & building scale around technology Services lines.
                  At Synoverge, we value and practice:
                </p>
                <ul className="icon-list mb-0">
          ...
          <Row>
            ...
            <Col xs={12} lg={6} className="common-sec">
              <div className="content-spacing-left">
                ...
                <p>
                  We share our customer’s vision and help them accomplish it
          ...
          <Row>
            ...
            >
              <div className="content-spacing-right">
                ...
                <p>
                  Inventing and creating incredible technology solutions that
                  endure the test of time, creating value for stakeholders.
                </p>
                <p className="mb-0">
                  With ongoing sustainable inventions and accomplishments for
                  clients, we are determined to realize our goals. We endeavour
                  to achieve our organizational objectives with greater vigour,
                  innovation, enhanced service delivery, and a broader outreach
                  to impact businesses and lives, positively.
                </p>
              </div>
            </Col>
            <Col
