            ...
            <Col xs={12} md={6}>
              <div className="banner-cont">
                ...
                <p>
                  ...
                  Pulses, we prioritize health without compromising on taste or
                  quality.
                </p>
              </div>
            </Col>
...
export default HealthyAndNutriFoods;
