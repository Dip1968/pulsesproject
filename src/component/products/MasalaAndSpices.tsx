          ...
          <Row>
            <Col xs={12} md={6}>
              <div className="banner-cont">
                <h1>Masala & Spices</h1>
                <p>
                  We deliver an authentic range of masalas and spices, including
                  turmeric, cumin, fennel, and chili powder. Our spices are
                  carefully processed to retain their aroma and flavor, ensuring
                  your dishes are rich in taste and quality.
                </p>
              </div>
            </Col>
            <Col xs={12} md={6}>
