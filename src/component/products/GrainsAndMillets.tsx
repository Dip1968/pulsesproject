          ...
          <Row>
            <Col xs={12} md={6}>
              <div className="banner-cont">
                <h1>Grains & Millets</h1>
                <p>
                  We provide a diverse selection of high-quality grains and
                  millets, such as wheat, rice, bajra, jowar, and ragi. Perfect
                  for a balanced and healthy diet, our grains are sourced
                  directly from trusted farms to meet the highest standards of
                  nutrition and taste.
                </p>
              </div>
            </Col>
