          ...
          <Row>
            <Col xs={12} md={6}>
              <div className="banner-cont">
                <h1>Rajma Kidney Beans</h1>
                <p>
                  Reliance Pulses brings you premium Rajma (Kidney Beans) known
                  for their superior taste, texture, and nutritional value. Our
                  Rajma is sourced and processed with care to ensure it meets
                  the demands of both traditional Indian dishes and global
                  cuisines.
                </p>
              </div>
            </Col>
...
export default RajmaKidneyBeans;
